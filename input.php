...
if ($con->query($sql) === TRUE) 
{
    ...
    echo "<p>Inserted Node: " . $last_id . " content: " . $_POST[data] . "</p>";

    $sql = "INSERT INTO Inputs (node_id) VALUES('$last_id')";

    if ($con->query($sql) === TRUE) 
    {
        $input_id = $con->insert_id;
        
    echo "<p>Inserted Input: " . $input_id . "</p>";
    } 
    else 
    {
                ...
                <table width="100%">
                    <tr height="75">
                        <td>
                            ...
                            <input type="hidden" name="parent" value="<?php echo $last_id;?>">
                        </td>
                    </tr>
                    <tr height="25">
                        <td>
